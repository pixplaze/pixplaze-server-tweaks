...
//            });
    ...
    public static Object tryInvokeMethodByName(Object object, String methodName, Object ... arguments) {
...
//    public static Object tryInvokeMethodByArguments(Object object, Object[] ... arguments) {
//
//    }

    public static Object tryInvokeMethodByArguments(Object object, Class<?>[] argumentTypes, Object[] argumentObjects) {
        ...
        for (var method : objectMethods) {
            ...
            System.err.printf(
                    "par. count: %d, arg. count: %d,%npar.: %s%n",
                    method.getParameterCount(),
                    argumentTypes.length,
                    Arrays.toString(methodParameterTypes));
            if (Arrays.equals(methodParameterTypes, argumentTypes)) {
                return tryInvokeMethod(object, method, argumentObjects);
            }
        }
